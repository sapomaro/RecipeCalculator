...
const wordFormsReplacements = [
  [re(wordFormsOpeners['_1'] + wordFormsEndings['mWords']), '$1$2 $3$4'],
  [re(wordFormsOpeners['_234'] + wordFormsEndings['mWords']), '$1$2 $3а$4'],
  [re(wordFormsOpeners['_567890'] + wordFormsEndings['mWords']), '$1$2 $3ов$4'],

  [re(wordFormsOpeners['_1'] + wordFormsEndings['fWords']), '$1$2 $3ка$4'],
  [re(wordFormsOpeners['_234'] + wordFormsEndings['fWords']), '$1$2 $3ки$4'],
  [re(wordFormsOpeners['_567890'] + wordFormsEndings['fWords']), '$1$2 $3ек$4'],
